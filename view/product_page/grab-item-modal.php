<div class="modal fade modal-grab-item" id="editQuantityModal" tabindex="-1" role="dialog" aria-labelledby="modal-grab-item" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div id="carouselNavigator" class="carousel slide" data-interval="5000" data-ride="carousel">
                                <div class="carousel-inner" id="image_slider">
                                    <div class="carousel-item active text-center">
                                        <img style=" display: center;max-width:150px;max-height:150px;width: auto;height: auto;" src="https://www.oderje.com/img/products/generic-product.jpg" class="w-75 float-" alt="Product image">
                                    </div>
                                ...
                                <a class="carousel-control-prev" href="#carouselNavigator" role="button" data-slide="prev">
                                    <i class="fas fa-angle-left text-dark" aria-hidden="true"></i>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" href="#carouselNavigator" role="button" data-slide="next">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mt-2 text-right">
                                <button type="button" id="add_to_backet_btn" data-toggle="modal" data-target=".modal-grab-item" class="btn btn-sm text-white" style="background:#FC9732">
                                    <input class="pbm_id" type="hidden" >Add to basket&nbsp;<i class="fas fa-shopping-basket"></i>
                                </button>
                                <button class="btn btn-sm btn-dark d-none">
                                    <input class="pbm_id" type="hidden">Fast Checkout&nbsp;&nbsp;<i class="fas fa-fighter-jet"></i>
                                </button>
                            </div>
                        </div>
                    </div>
...
<!-- <div class="modal fade modal-grab-item" tabindex="-1" role="dialog" aria-labelledby="modal-grab-item" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
