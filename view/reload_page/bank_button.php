...
<div class="col-6 col-md-3">
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="paymentMethod" bank-name="CIMB Clicks" value="BCBB0235">
        <div class="card border-white my-1">
            <label class="form-check-label text-center" for="BCBB0235">
                <img src="../img/payment-logo/BCBB0235.png" class="img-fluid" alt="online banking" width="30px">
                <br><small>CIMB&nbsp;Clicks</small>
            </label>
        </div>
    </div>
</div>
    ...
    <div class="form-check form-check-inline">
        ...
        <div class="card border-white my-1">
            <label class="form-check-label text-center" for="SCB0216">
                ...
                <br><small>Standard Chartered</small>
            </label>
        </div>
    </div>
</div>
