	...
	<div class="container-fluid">
		<div class="row" style="margin-top:80px">
			...
			<div class="col-md-8 col-10 box bg-light bubble-high">
				...
				<div class="col-12 text-center font-weight-bold mt-3">Check your email</div>
				<div class="col-12 text-center mt-3 font-weight-bold d-none">gif</div>
				<div class="col-12 text-center mt-3 font-weight-bold">We have sent a link to reset your password. Please check your inbox.</div>
			</div>
			<div class="col-md-2 col-1 "></div>
		</div>
	</div>
